...
The `train_vae.py` script is configured to train models locally (by default) or on a [SLURM cluster](./configs/cluster/mycluster.yaml) (by passing `cluster=my_cluster`). Simply run: 
